package ResellerClub::ProductService;
...
# -- generated from file:wsdl/Product.wsdl
my %methods = (
getProductMetadata => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.Product',
    parameters => [
  ...
  }, # end getProductMetadata
getResellerActiveProductCategory => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.Product',
    parameters => [
  ...
  }, # end getResellerActiveProductCategory
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.Product","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.Product","impl");
