package ResellerClub::OrderSetupService;
...
# -- generated from file:wsdl/OrderSetup.wsdl
my %methods = (
getResellerSlabPriceForProducts => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.OrderSetup',
    parameters => [
      ...
      SOAP::Data->new(name => 'productKeyArr', type => 'impl:ArrayOf_xsd_string', attr => {}),
    ], # end parameters
  }, # end getResellerSlabPriceForProducts
getPricingKeyPricingParamMap => {
  ...
  }, # end getPricingKeyPricingParamMap
getCustomerCostPrice => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'Customerid', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'productKey', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getCustomerCostPrice
...
getPaymentCollectionParams => {
  ...
  }, # end getPaymentCollectionParams
...
getPricingParamsDisplayName => {
  ...
  }, # end getPricingParamsDisplayName
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.OrderSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.OrderSetup","impl");
