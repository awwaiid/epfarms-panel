package ResellerClub::DotTravelService;
...
# -- generated from file:wsdl/DotTravel.wsdl
my %methods = (
getEligibleDomains => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.domorder.DotTravel',
    parameters => [
      ...
      SOAP::Data->new(name => 'uin', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getEligibleDomains
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.DotTravel","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.DotTravel","impl");
