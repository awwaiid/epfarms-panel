...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.util.Country","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.util.Country","impl");
