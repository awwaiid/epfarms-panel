package ResellerClub::DomContactService;
# Generated by SOAP::Lite (v0.710.08) for Perl -- soaplite.com
# Copyright (C) 2000-2006 Paul Kulchenko, Byrne Reese
# -- generated at [Sun Feb  8 01:13:51 2009]
# -- generated from file:wsdl/DomContact.wsdl
my %methods = (
addDefaultContact => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.DomContact',
    parameters => [
...
listByType => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'customerId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'contactId', type => 'impl:ArrayOf_xsd_int', attr => {}),
      ...
      SOAP::Data->new(name => 'requirements', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end listByType
getDefaultContacts => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'customerId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'types', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getDefaultContacts
addDefaultContacts => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.DomContact',
...
getDetails => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'contactId', type => 'xsd:int', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomContact","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomContact","impl");
