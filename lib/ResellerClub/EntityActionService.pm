package ResellerClub::EntityActionService;
...
# -- generated from file:wsdl/EntityAction.wsdl
my %methods = (
listArchive => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.entity.EntityAction',
    parameters => [
      ...
      SOAP::Data->new(name => 'actionAddedRangeStart', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'actionAddedRangeEnd', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'actionStartedRangeStart', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'actionStartedRangeEnd', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'actionCompletedRangeStart', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'actionCompletedRangeEnd', type => 'xsd:string', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.entity.EntityAction","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.entity.EntityAction","impl");
