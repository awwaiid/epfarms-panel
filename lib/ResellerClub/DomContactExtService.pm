package ResellerClub::DomContactExtService;
...
# -- generated from file:wsdl/DomContactExt.wsdl
my %methods = (
isValidContact => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.DomContactExt',
    parameters => [
      ...
      SOAP::Data->new(name => 'contactIdArr', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'eligibilityCriteriaArr', type => 'impl:ArrayOf_xsd_string', attr => {}),
    ], # end parameters
  }, # end isValidContact
setContactDetails => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'contactDetailsHash', type => 'xsd:string', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomContactExt","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomContactExt","impl");
