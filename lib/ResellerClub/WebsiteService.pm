package ResellerClub::WebsiteService;
...
# -- generated from file:wsdl/Website.wsdl
my %methods = (
moveWebsite => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.Website',
    parameters => [
      ...
      SOAP::Data->new(name => 'websiteName', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'newCustomerId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'defaultcontact', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end moveWebsite
list => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'showChildWebSites', type => 'xsd:boolean', attr => {}),
      SOAP::Data->new(name => 'websiteName', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'status', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'productKey', type => 'impl:ArrayOf_xsd_string', attr => {}),
      ...
      SOAP::Data->new(name => 'searchflag', type => 'xsd:boolean', attr => {}),
    ], # end parameters
  }, # end list
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.Website","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.Website","impl");
