...
bulkSuspendOrders => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'entityIds', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'add', type => 'xsd:boolean', attr => {}),
      SOAP::Data->new(name => 'reason', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'removeChildLocks', type => 'xsd:boolean', attr => {}),
    ], # end parameters
  }, # end bulkSuspendOrders
bulkLockResellerOrders => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'resellerIds', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'lockName', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'add', type => 'xsd:boolean', attr => {}),
      SOAP::Data->new(name => 'reason', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'removeChildLocks', type => 'xsd:boolean', attr => {}),
    ], # end parameters
  }, # end bulkLockResellerOrders
listCurrentActions => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.Order',
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'eaqId', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'entityId', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'entitytypeid', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'actionStatus', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'actionType', type => 'impl:ArrayOf_xsd_string', attr => {}),
...
bulkLockCustomerOrders => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'customerIds', type => 'impl:ArrayOf_xsd_int', attr => {}),
      SOAP::Data->new(name => 'lockName', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'add', type => 'xsd:boolean', attr => {}),
      SOAP::Data->new(name => 'reason', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'removeChildLocks', type => 'xsd:boolean', attr => {}),
    ], # end parameters
  }, # end bulkLockCustomerOrders
getDetails => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.Order',
...
getOrderIdByDomainAndProductCategory => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'productCategory', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getOrderIdByDomainAndProductCategory
listArchivedActions => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.Order',
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.Order","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.Order","impl");
