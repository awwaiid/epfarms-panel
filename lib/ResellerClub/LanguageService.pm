package ResellerClub::LanguageService;
...
# -- generated from file:wsdl/Language.wsdl
my %methods = (
getAllLanguageList => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.util.Language',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.util.Language","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.util.Language","impl");
