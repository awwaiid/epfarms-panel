package ResellerClub::PaymentGatewayService;
...
# -- generated from file:wsdl/PaymentGateway.wsdl
my %methods = (
getAllPaymentGateways => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.paymentgateway.PaymentGateway',
    parameters => [
...
list => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'PaymentTypeId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'transId', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'userId', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'sub_role', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'transType', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'description', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'startDate', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'endDate', type => 'xsd:string', attr => {}),
...
listPaymentGatwayNames => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'customerAccessLevel', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'resellerAccessLevel', type => 'impl:ArrayOf_xsd_string', attr => {}),
      SOAP::Data->new(name => 'numOfRecordPerPage', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'pageNum', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'orderBy', type => 'impl:ArrayOf_xsd_string', attr => {}),
    ], # end parameters
  }, # end listPaymentGatwayNames
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.paymentgateway.PaymentGateway","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.paymentgateway.PaymentGateway","impl");
