package ResellerClub::DotTelService;
...
# -- generated from file:wsdl/DotTel.wsdl
my %methods = (
getCTHLoginDetails => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.domorder.DotTel',
    parameters => [
...
modifyWhoisPreference => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'orderId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'whoisType', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'publish', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end modifyWhoisPreference
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.DotTel","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.DotTel","impl");
