package ResellerClub::CurrencyService;
...
# -- generated from file:wsdl/Currency.wsdl
my %methods = (
getCurrencyDetails => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.util.Currency',
    parameters => [
      ...
      SOAP::Data->new(name => 'currencySymbol', type => 'xsd:string', attr => {}),
    ], # end parameters
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.util.Currency","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.util.Currency","impl");
