package ResellerClub::LegalAgreementService;
...
# -- generated from file:wsdl/LegalAgreement.wsdl
my %methods = (
getAgreement => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.management.LegalAgreement',
    parameters => [
      ...
      SOAP::Data->new(name => 'callByParent', type => 'xsd:boolean', attr => {}),
      SOAP::Data->new(name => 'agreementType', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getAgreement
...
getAllAgreements => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'agreementType', type => 'impl:ArrayOf_xsd_string', attr => {}),
    ], # end parameters
  }, # end getAllAgreements
getProductCategory => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.management.LegalAgreement',
    parameters => [
      ...
      SOAP::Data->new(name => 'signupAction', type => 'xsd:string', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.management.LegalAgreement","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.management.LegalAgreement","impl");
