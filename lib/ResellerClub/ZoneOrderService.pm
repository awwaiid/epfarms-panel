package ResellerClub::ZoneOrderService;
# Generated by SOAP::Lite (v0.710.08) for Perl -- soaplite.com
# Copyright (C) 2000-2006 Paul Kulchenko, Byrne Reese
# -- generated at [Wed Aug 26 01:07:58 2009]
# -- generated from file:wsdl/ZoneOrder.wsdl
my %methods = (
setupDNSService => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.dnsbox.Zone',
    parameters => [
...
getDetails => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_LANGPREF', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'zoneid', type => 'xsd:int', attr => {}),
...
mod => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'zoneid', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'modnoofrecords', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'modnoofyears', type => 'xsd:int', attr => {}),
    ], # end parameters
  }, # end mod
list => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'recordtype', type => 'xsd:string', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.dnsbox.Zone","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.dnsbox.Zone","impl");
