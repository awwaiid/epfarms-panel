package ResellerClub::ThirdLevelDotUkService;
...
# -- generated from file:wsdl/ThirdLevelDotUk.wsdl
my %methods = (
activateTransferredDomain => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.domorder.ThirdLevelDotUk',
    parameters => [
      ...
      SOAP::Data->new(name => 'securityKey', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'customerId', type => 'xsd:int', attr => {}),
    ], # end parameters
  }, # end activateTransferredDomain
releaseDomain => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.domorder.ThirdLevelDotUk',
    parameters => [
      ...
      SOAP::Data->new(name => 'newTag', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end releaseDomain
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.ThirdLevelDotUk","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.domorder.ThirdLevelDotUk","impl");
