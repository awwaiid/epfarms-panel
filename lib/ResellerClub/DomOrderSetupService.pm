package ResellerClub::DomOrderSetupService;
...
# -- generated from file:wsdl/DomOrderSetup.wsdl
my %methods = (
getCustomerCostPrice => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.DomOrderSetup',
    parameters => [
...
listResellerTldsPricingDetails => {
  ...
  }, # end listResellerTldsPricingDetails
getResellerTldsSettingsPref => {
  ...
  }, # end getResellerTldsSettingsPref
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomOrderSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.DomOrderSetup","impl");
